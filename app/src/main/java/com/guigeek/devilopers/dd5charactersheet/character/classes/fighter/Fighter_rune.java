...
public class Fighter_rune extends BaseArchetype {
    ...
    Power[] _runes = new Power[]{
            new Power("[Rune] Haug (Hill Rune)", "This rune’s magic bestows a resilience reminiscent of a hill giant. While wearing or carrying an object inscribed with this rune, you have advantage on saving throws against being poisoned, and you have resistance against poison damage.\n" +
                    "\n" +
                    "In addition, you can invoke the rune as a bonus action, gaining resistance to bludgeoning, piercing, and slashing damage for 1 minute. Once you invoke the rune, you can’t do so again until you finish a short or long rest.", "", -1, -1, false, Enumerations.ActionType.PASSIVE),
            new Power("[Rune] Ild (Fire Rune)", "This rune’s magic channels the masterful craftsmanship of fire giant smiths. While wearing or carrying an object inscribed with this rune, your proficiency bonus is doubled for any ability check you make that uses your proficiency with a tool.\n" +
                    "\n" +
                    "In addition, when you hit a creature with a weapon attack, you can invoke the rune to summon fiery shackles: the target must succeed on a Strength saving throw or be restrained for 1 minute. While restrained by the shackles, the target takes 2d6 fire damage at the start of each of its turns. The target can repeat the saving throw at the end of each of its turns, banishing the shackles on a success. Once you invoke the rune, you can’t do so again until you finish a short or long rest.", "", -1, -1, false, Enumerations.ActionType.PASSIVE),
            new Power("[Rune] Ise (Frost Rune)", "This rune’s magic evokes a frost giant’s stoic calm. While wearing or carrying an object inscribed with this rune, you have advantage on Wisdom (Animal Handling) checks and Charisma (Intimidation) checks.\n" +
                    "\n" +
                    "In addition, you can invoke the rune as a bonus action to increase your Strength score by 2 for 10 minutes. This increase can cause your score to exceed 20, but not 30. Once you invoke the rune, you can’t do so again until you finish a short or long rest.", "", -1, -1, false, Enumerations.ActionType.PASSIVE),
            new Power("[Rune] Skye (Cloud Rune)", "This rune’s magic emulates the deceptiveness of a cloud giant. While wearing or carrying an object inscribed with this rune, you have advantage on Dexterity (Sleight of Hand) checks and Charisma (Deception) checks.\n" +
                    "\n" +
            ...
            new Power("[Rune] Stein (Stone Rune)", "This rune’s magic channels the insightfulness of a stone giant. While wearing or carrying an object inscribed with this rune, you have advantage on Wisdom (Insight) checks, and you have darkvision out to a range of 60 feet. If you already have darkvision, its range increases by 30 feet.\n" +
                    "\n" +
            ...
            new Power("[Rune] Uvar (Storm Rune)", "Using this rune, you can glimpse the future like a storm giant. While wearing or carrying an object inscribed with this rune, you have advantage on Intelligence (Arcana) checks, and you can’t be surprised as long as you are not incapacitated.\n" +
                    "\n" +
    ...
    public List<Power> getAllArchetypeFeatures(int iClassLevel) {
        return Arrays.asList(_runes);
    }

    @Override
    public boolean canReplaceFeature(int iClasseLevel) {
        return iClasseLevel > 3;
    }

    @Override
    public int nbOfFeatures(int iLevel) {
        return iLevel >= 15 ? 5 : iLevel >= 10 ? 4 : iLevel >= 7 ? 3 : 2;
    }
    ...
    public LinkedList<Power> getPowers(int iLevel, Character iCharac) {
        ...
        if (iLevel >= 3) {
            powers.add(new Power("Rune Magic", "" +
                    "[Known Runes] " + nbOfFeatures(iLevel) +
